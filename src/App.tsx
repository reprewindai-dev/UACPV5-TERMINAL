  ...
  return (
    <div className="shell">
      ...
      <div className="bnav" role="tablist">
        <button role="tab" aria-selected={activeView === 'terminal'} aria-controls="v-terminal" className={`bt ${activeView === 'terminal' ? 'active' : ''} focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:outline-none`} onClick={() => setActiveView('terminal')}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
            <polyline points="4 17 10 11 4 5"/><line x1="12" y1="19" x2="20" y2="19"/>
          </svg>Terminal
        </button>
        <button role="tab" aria-selected={activeView === 'mesh'} aria-controls="v-mesh" className={`bt ${activeView === 'mesh' ? 'active' : ''} focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:outline-none`} onClick={() => setActiveView('mesh')}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
            <circle cx="12" cy="5" r="2"/><circle cx="5" cy="19" r="2"/><circle cx="19" cy="19" r="2"/>
            <line x1="12" y1="7" x2="12" y2="12"/><line x1="12" y1="12" x2="5" y2="17"/><line x1="12" y1="12" x2="19" y2="17"/>
          </svg>Mesh
        </button>
        <button role="tab" aria-selected={activeView === 'tele'} aria-controls="v-tele" className={`bt ${activeView === 'tele' ? 'active' : ''} focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:outline-none`} onClick={() => setActiveView('tele')}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
             <polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/>
          </svg>Telemetry
        </button>
        <button role="tab" aria-selected={activeView === 'paths'} aria-controls="v-paths" className={`bt ${activeView === 'paths' ? 'active' : ''} focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:outline-none`} onClick={() => setActiveView('paths')}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
            <path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/>
          </svg>Paths
        </button>
        <button role="tab" aria-selected={activeView === 'engine'} aria-controls="v-engine" className={`bt ${activeView === 'engine' ? 'active' : ''} focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:outline-none`} onClick={() => setActiveView('engine')}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
             <circle cx="12" cy="12" r="3"/><path d="M19.07 4.93a10 10 0 010 14.14M4.93 4.93a10 10 0 000 14.14"/>
          </svg>Engine
        </button>
        <button role="tab" aria-selected={activeView === 'hub'} aria-controls="v-hub" className={`bt ${activeView === 'hub' ? 'active' : ''} focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:outline-none`} onClick={() => setActiveView('hub')}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
             <polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/>
          </svg>Hub
        </button>
        <button role="tab" aria-selected={activeView === 'dashboard'} aria-controls="v-dashboard" className={`bt ${activeView === 'dashboard' ? 'active' : ''} focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:outline-none`} onClick={() => setActiveView('dashboard')}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
